/*
Package buffer contains buffer and wrapper types for byte slices. It is useful for writing a tokenizer or other high-performance byte slice handling.
...
The `Shifter` type is useful for building tokenizers because it keeps track of the start and end position of a byte selection, and shifts the bytes whenever a valid token is found.
*/
